...
same family as our own `verification/resistance.py`, which measured no downstream benefit across 34 datasets
...
**Morgan r=4 added.** The prediction was recorded in `verification/embed_pairs.py:arm_r4cfp` before the
