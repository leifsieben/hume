...
Supersedes the round in `docs/selection/HUME_300_METHOD.md`, which is kept for its findings and its errors.
...
## THE STOPPING RULE, fixed before any result
...
### SECOND AMENDMENT, 2026-09-06 — AFTER seeing that no N passed
...
## HELD OUT, 33 Figure C panels — 200 FAILS THE GATE
