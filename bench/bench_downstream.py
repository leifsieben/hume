"""Figures B and C: does each representation help downstream, and at what cost?
    ...
    CHEMPFN_DATA_ROOT=~/chempfn-data python bench/bench_downstream.py --arms ecfp hume --out out.json
...
#: inner-validation size below which we use docs/API.md section 7's documented default instead of
