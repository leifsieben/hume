"""Pull the downstream grid off S3 and build the Figure B and Figure C contracts.
    ...
    python3 bench/collect_downstream.py            # fetch, aggregate, write both results.json
...
def fetch():
    ...
    # however recently the older file was written -- see PROTO in bench/bench_downstream.py. Records
